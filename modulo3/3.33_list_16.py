# https://edube.org/learn/python-essentials-1-esp/resumen-de-la-secci-oacute-n-18
# 1. La comprensión de listas te permite crear nuevas listas a partir de las existentes 
# de una manera concisa y elegante. La sintaxis de una comprensión de lista es la siguiente:
...
# Este es un ejemplo de una comprensión de lista: el código siguiente crea una lista de cinco elementos 
...
# por ejemplo, arreglos de tres, cuatro o incluso sesenta y cuatro dimensiones.
